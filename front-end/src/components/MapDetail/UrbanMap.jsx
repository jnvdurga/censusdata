...
function UrbanSectorMap({ departmentCode, municipalityCode, classCode, onUrbanSelect }) {
    ...
    async function fetchUrbanAreas() {
      try {
        const res = await fetch(
          `http://localhost:5000/api/urban-areas/${departmentCode}/${municipalityCode}/${classCode}`
        );
